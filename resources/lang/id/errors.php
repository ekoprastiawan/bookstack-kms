...
return [
    ...
    // Permissions
    'permission' => 'Anda tidak memiliki hak akses untuk mengakses halaman yang diminta.',
    'permissionJson' => 'Anda tidak memiliki hak akses untuk melakukan tindakan yang diminta.',
    ...
    'server_upload_limit' => 'Server tidak menghak akseskan unggahan dengan ukuran ini. Harap coba ukuran berkas yang lebih kecil.',
    'uploaded'  => 'Server tidak menghak akseskan unggahan dengan ukuran ini. Harap coba ukuran berkas yang lebih kecil.',
    ...
    // Pages
    'page_draft_autosave_fail' => 'Gagal menyimpan konsep. Pastikan Anda memiliki koneksi internet sebelum menyimpan halaman ini',
    ...
    'sorry_page_not_found_permission_warning' => 'Jika Anda mengharapkan halaman ini ada, Anda mungkin tidak memiliki hak akses untuk melihatnya.',
    ...
    'api_user_no_api_permission' => 'Pemilik token API yang digunakan tidak memiliki hak akses untuk melakukan panggilan API',
